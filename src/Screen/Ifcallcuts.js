import {
  ...
  export default function IfcallcutsScreen() {
                ...
                22 March , Tuesday at (08:30 AM - 09:00 PM){' '}
                    ...
                    <View style={styles.collectviewassume}>
                        ...
                        <View style={styles.collectinside}>
                            <TouchableOpacity onPress={() => {navigation.navigate('PatientScreen')}} ><Image style={styles.vectoricon} source={require('../Assets/Image/videoicon.png')}/></TouchableOpacity>
                            <View>
