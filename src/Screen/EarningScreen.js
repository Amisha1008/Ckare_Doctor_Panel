      ...
      <ScrollView>
        <View style={{justifyContent: 'space-between'}}>
          ...
          <View style={styles.whitebar}>
                  ...
                  return (
                    <TouchableOpacity
                      ...
                      style={[
                        ...
                        {
                          borderColor: isDateIsActive(list)
                            ? '#00E0C5'
                            : '#E1E1E1',
                        },
                      ]}
                      ...
                      <View>
                        <Text
                          style={{
                            fontSize: 15,
                            fontFamily: 'Mulish',
                            color: isDateIsActive(list) ? 'black' : '#222222',
                            fontWeight: '600',
                          }}>
                          {list.x}
                        </Text>
            ...
            {/* new */}
            <View style={styles.todayBookingDivs}>
              <View style={styles.todayBookingDiv}>
                <LinearGradient
                  colors={['#009987', '#00E0C5']}
                  style={styles.tenTxtDiv}>
                  <Text style={styles.tenTxt}>10</Text>
                </LinearGradient>
                <Text style={styles.todaysBookingTxt}>Todays Booking</Text>
              </View>
              <View style={styles.todayBookingDiv}>
                <LinearGradient
                  colors={['#009987', '#00E0C5']}
                  style={styles.tenTxtDiv}>
                  <Text style={styles.tenTxt}>₹1500</Text>
                </LinearGradient>
                <Text style={styles.todaysBookingTxt}>Total Earnings</Text>
              </View>
            </View>
            ...
            <TouchableOpacity
              onPress={() => {
                navigation.navigate('EarningScreen2', {});
              }}
              ...
              <View
                ...
                <Text style={{fontSize: 16, marginBottom: 3}}>
                  <FontAwesome5Icons name="rupee-sign" size={16} /> 240
                </Text>
