...
import DocumentPicker from 'react-native-document-picker';
  ...
  export default function PatientScreentwo() {
            ...
            <View style={{marginHorizontal: 15,marginBottom:10}}>
              <Text style={{fontSize: 14, letterSpacing: 0.23, lineHeight: 20}}>
                22 March , Tuesday at (08:30 AM - 09:00 PM){' '}
                    ...
                    <TouchableOpacity onPress={() => {navigation.navigate('AfterCall')}} style={styles.buttonview}>
                        <ButtonFieldScreen text='Completed' />
                    </TouchableOpacity>
