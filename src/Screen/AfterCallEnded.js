...
import ButtonFieldScreen from '../Component/ButtonFieldScreen';
  ...
  showsHorizontalScrollIndicator={false}>
          ...
          <View>
                ...
                lectus a nunc dictum cursus. Praesent aliquam leo sit amet elit.
                    ...
                    <View style={styles.collectviewassume}>
                        ...
                        <View style={styles.collectinside}>
                            <TouchableOpacity ><Image style={styles.vectoricon} source={require('../Assets/Image/videoicon.png')}/></TouchableOpacity>
                            <View>
                            <View><Text style={styles.collectext}>Video Conference</Text></View>
                            <View><Text style={styles.seeyoutext}>See your docotor live.</Text></View>
                            </View>
                        </View>
                    </View>
            ...
            <TouchableOpacity onPress={()=> {navigation.navigate('HomeConsult')}} style={styles.buttonview} >
                <ButtonFieldScreen text='Create Prescription' />
            </TouchableOpacity>
